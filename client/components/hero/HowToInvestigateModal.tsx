...
export default function HowToInvestigateModal({
  ...
  // Guard against SSR — portals require document
          ...
          >
            ...
            <div className="space-y-3.5 font-serif">
              <div className="flex gap-4 items-start rounded-lg border border-zinc-800/50 bg-zinc-900/40 p-3.5">
                <span className="font-mono text-sm font-black text-red-500 tracking-widest shrink-0 mt-0.5">01</span>
                <div>
                  <h4 className="font-bold text-sm uppercase tracking-wider text-zinc-200">INVESTIGATE</h4>
                  <p className="mt-0.5 text-xs text-zinc-400 leading-relaxed font-sans">Examine the case and uncover clues.</p>
                </div>
              </div>

              <div className="flex gap-4 items-start rounded-lg border border-zinc-800/50 bg-zinc-900/40 p-3.5">
                <span className="font-mono text-sm font-black text-red-500 tracking-widest shrink-0 mt-0.5">02</span>
                <div>
                  <h4 className="font-bold text-sm uppercase tracking-wider text-zinc-200">INTERROGATE</h4>
                  <p className="mt-0.5 text-xs text-zinc-400 leading-relaxed font-sans">Question your assigned AI suspect. Their answers may change under pressure or when confronted with evidence.</p>
                </div>
              </div>

              <div className="flex gap-4 items-start rounded-lg border border-zinc-800/50 bg-zinc-900/40 p-3.5">
                <span className="font-mono text-sm font-black text-red-500 tracking-widest shrink-0 mt-0.5">03</span>
                <div>
                  <h4 className="font-bold text-sm uppercase tracking-wider text-zinc-200">DISCUSS</h4>
                  <p className="mt-0.5 text-xs text-zinc-400 leading-relaxed font-sans">Share discoveries with your team and build your theory.</p>
                </div>
              </div>

              <div className="flex gap-4 items-start rounded-lg border border-zinc-800/50 bg-zinc-900/40 p-3.5">
                <span className="font-mono text-sm font-black text-red-500 tracking-widest shrink-0 mt-0.5">04</span>
                <div>
                  <h4 className="font-bold text-sm uppercase tracking-wider text-zinc-200">ACCUSE</h4>
                  <p className="mt-0.5 text-xs text-zinc-400 leading-relaxed font-sans">Vote for the suspect you believe committed the murder.</p>
                </div>
              </div>
            </div>
